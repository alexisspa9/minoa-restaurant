...
$(function () {
    ...
    // var langValue = html[0].getAttribute('lang');

    // var etable = document.querySelector(".etable");
    // var etableLink  = document.querySelector(".etableLink");
    // if (langValue == "en") {
    //     etableLink.textContent = "Book a table";
    // }
    // etable.style.textAlign = "center";
    // etableLink.style.display = "block";
    // etableLink.style.maxWidth = "350px";
    // etableLink.style.margin = "15px auto";
    ...
    map = new Map(document.getElementById("map"), {
        center: { lat: 37.123562, lng: 25.239291 },
        zoom: 18,
    });
    new google.maps.Marker({
        position: { lat: 37.123562, lng: 25.239291 },
        map,
        title: "Minoa Restaurant",
      });
    }
